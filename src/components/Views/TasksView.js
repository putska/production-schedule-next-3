        ...
        <div>
...

            {
                ...
                >
                        ...
                        cellRender={cell => {
                            return (cell.rowType == "data" &&
                                <Grid container direction="row">
                                    <Grid item>
                                        <IconButton aria-label="edit" onClick={(e) => handleFormOpen(cell.data)}>
                                            <EditIcon color="primary" style={{ fontSize: "18px" }} />
                                        </IconButton>
                                    </Grid>

                                    <Grid item>
                                        <IconButton aria-label="delete" onClick={(e) => deleteHandler(cell, "tasks")}>
                                            <DeleteIcon color="secondary" style={{ fontSize: "18px" }} />
                                        </IconButton>
                                    </Grid>
                                </Grid>
                    ...
                    <Column dataField="task" caption="Task" alignment="center" fixed minWidth="100" />
                    <Column dataField="description" caption="Description" alignment="center" fixed minWidth="100" />
                    <Column
